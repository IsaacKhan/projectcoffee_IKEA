								...
								<div class="table100-body js-pscroll">
									<table>
										<tbody>
												...
												{
													$sql = "SELECT productName, productType, productPrice, productBrand, productDescription FROM product WHERE productType=\"Bathroom\"";
													$result = $conn-> query($sql);
													echo "<table>";
														while($row = $result->fetch_assoc())
														{
															echo "<tr class=\"row100 head\"><td class=\"cell100 column1\">" . $row["productName"] . "</td><td class=\"cell100 column2\">" . $row["productType"] . "</td><td class=\"cell100 column3\">" . $row["productPrice"] . "</td><td class=\"cell100 column4\">" . $row["productBrand"] . "</td><td class=\"cell100 column5\">" . $row["productDescription"] . "</td></tr>"; 
														}
													echo "</table>";
