...
<body>
	<div id="wrapper">
		<div class="wrapper-holder">
			<header id="header">
				<span class="logo"><a href="index.php">IKEA</a></span>
								...
								<div class="table100-body js-pscroll">
									<table>
										<tbody>
												...
												{
													$sql = "SELECT productName, productType, productPrice, productBrand, productDescription FROM product WHERE productType=\"Kitchen\"";
